...
CLASS lhc_Supplement IMPLEMENTATION.
  ...
  METHOD calculateTotalSupplPrice.
    ...
    IF NOT keys IS INITIAL.
      zcl_aux_travel_det_log_07=>calculate_price( it_travel_id = VALUE #( FOR GROUPS
                                                                         <booking_suppl> OF booking_key IN keys GROUP BY
                                                                         booking_key-travel_id  WITHOUT MEMBERS ( <booking_suppl> ) )  ).
    ENDIF.
...
CLASS lsc_supplement IMPLEMENTATION.
  ...
  METHOD save_modified.
    ...
    DATA: lt_supplements TYPE STANDARD TABLE OF zbooksuppl_log_7,
    ...
    IF NOT lt_supplements IS INITIAL.
      ...
      CALL FUNCTION 'ZFM_SUPPL_LOG_07'
        EXPORTING
