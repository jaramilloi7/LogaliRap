CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    "acceptTravel, rejectTravel, createTravelByTemplate
    ...
    "validateCustomer, validateDates, validateStatus
    METHODS: validateCustomer FOR VALIDATE ON SAVE
      IMPORTING keys FOR Travel~validateCustomer,
      validateDates FOR VALIDATE ON SAVE
        IMPORTING keys FOR Travel~validateDates,
      validateStatus FOR VALIDATE ON SAVE
...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_authorizations.
    ...
    DATA(lv_auth) = COND #( WHEN cl_abap_context_info=>get_user_technical_name(  ) EQ 'CB9980004536'
...
* Modify in local mode - BO - related updates there are not relevant for autorization objects
    MODIFY ENTITIES OF z_i_travel_log_07 IN LOCAL MODE
           ENTITY Travel
    ...
    READ ENTITIES OF z_i_travel_log_07 IN LOCAL MODE
     ENTITY Travel
     FIELDS ( agency_id
              customer_id
              begin_date
    ...
    LOOP AT lt_travel ASSIGNING FIELD-SYMBOL(<ls_travel>).
      ...
      APPEND VALUE #( travel_id = <ls_travel>-travel_id
                      %msg      = new_message( id       = 'Z_MC_TRAVEL_LOG_07'
                                               number   =  '006'
                                               v1       = lv_travel_msg
...
*      REPORTED reported.
    ...
    DATA lt_create_travel TYPE TABLE FOR CREATE z_i_travel_log_07\\Travel.

    SELECT MAX( travel_id ) FROM ztravel_log_07
...
* Modify in local mode - BO - related updates there are not relevant for autorization objects
  ...
  METHOD validateDates.
    ...
    READ ENTITY z_i_travel_log_07\\Travel
...
CLASS lsc_Z_I_TRAVEL_LOG_07 DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_Z_I_TRAVEL_LOG_07 IMPLEMENTATION.

  METHOD save_modified.
    DATA: lt_travel_log   TYPE STANDARD TABLE OF zlog_log_07,
          lt_travel_log_u TYPE STANDARD TABLE OF zlog_log_07.
    ...
    IF NOT create-travel IS INITIAL.
      ...
      LOOP AT lt_travel_log ASSIGNING FIELD-SYMBOL(<ls_travel_log>).
        ...
        <ls_travel_log>-changing_operation = lsc_Z_I_TRAVEL_LOG_07=>create.
        ...
        IF sy-subrc EQ 0.
          IF ls_travel-%control-booking_fee EQ cl_abap_behv=>flag_changed.
            <ls_travel_log>-changing_field_name = 'booking_fee'.
            <ls_travel_log>-changing_value = ls_travel-booking_fee.
    ...
    IF NOT update-travel IS INITIAL.
      ...
      LOOP AT update-travel INTO DATA(ls_update_travel).
        ...
        <ls_travel_log_bd>-changing_operation = lsc_Z_I_TRAVEL_LOG_07=>update.

        IF ls_update_travel-%control-customer_id EQ cl_abap_behv=>flag_changed.
          <ls_travel_log_bd>-changing_field_name = 'customer_id'.
          <ls_travel_log_bd>-changing_value = ls_update_travel-customer_id.
    ...
    IF NOT delete-travel IS INITIAL.
      ...
      LOOP AT lt_travel_log ASSIGNING FIELD-SYMBOL(<ls_travel_log_del>).
        ...
        <ls_travel_log_del>-changing_operation = lsc_Z_I_TRAVEL_LOG_07=>delete.
    ...
    IF NOT lt_travel_log_u IS INITIAL.
      INSERT zlog_log_07 FROM TABLE @lt_travel_log_u.
    ENDIF.
